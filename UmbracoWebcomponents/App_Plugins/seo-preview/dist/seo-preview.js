import { css as l, customElement as c, LitElement as p, html as d } from "@umbraco-cms/backoffice/external/lit";
var u = Object.getOwnPropertyDescriptor, h = (e, t, i, n) => {
  for (var r = n > 1 ? void 0 : n ? u(t, i) : t, a = e.length - 1, s; a >= 0; a--)
    (s = e[a]) && (r = s(r) || r);
  return r;
};
let o = class extends p {
  ...
  _onTitleInput(e) {
    const t = e.target.value, i = this.value;
  ...
  render() {
    const e = this.value, t = this._truncateText(e.metaTitle, 60), i = this._truncateText(e.metaDescription, 155);
    return d`
...
o = h([
  c("my-seo-preview-property-editor-ui")
], o);
export {
  o as default
};
//# sourceMappingURL=seo-preview.js.map
