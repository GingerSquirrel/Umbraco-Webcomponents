...
@customElement('my-seo-preview-property-editor-ui')
export default class MySEOPreviewPropertyEditorUIElement extends LitElement {
...
declare global {
    interface HTMLElementTagNameMap {
        'my-seo-preview-property-editor-ui': MySEOPreviewPropertyEditorUIElement;
    }
}
